...
public final class Constants {
    ...
    public final static String FAREWELL = "Спасибо, что воспользовались нашим приложением, до свидания!!!";
    public final static String MAIN_MENU = """
            ...
            """;
    public final static String CREATING_LOGIN = "Пожалуйста, задайте логин.";
    public final static String CREATING_PASSWORD = "Пожалуйста, задайте пароль.";
    public final static String REGISTRATION_SUCCESSFUL = "Регистрация прошла успешно.";
    public final static String LOGIN_IS_BUSY = "Данный логин уже занят, попробуйте ввести другой.";
    public final static String INCORRECT_LOGIN = """
            ...
            Пожалуйста, задайте корректный логин.""";
    public static final String INCORRECT_PASSWORD = """
            ...
            а также состоять минимум из 5 символов, но не превышать длину 32 символа.
            Пожалуйста, задайте корректный пароль.""";
