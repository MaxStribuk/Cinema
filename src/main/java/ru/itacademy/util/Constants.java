...
public final class Constants {
    ...
    public static final String FAILED_RETURN_TICKET = "К сожалению, возврат билета не удался. " +
            "Возможно, Вы пытаетесь вернуть билет, " +
            "который у Вас отсутствует, либо сеанс по данному билету уже начался.";
    ...
    public static final String SUCCESSFUL_RETURN_TICKET = "Поздравляем, Вы сдали билет. " +
            "На Вашу карточку было возвращено ";
    ...
    public static final String MENU_MANAGER = """
            ...
            10 - для выкупа билета пользователя
            """;
    ...
    public static final String MENU_MOVIE = "Пожалуйста, введите ID фильма, " +
            "на который Вы желаете приобрести билет, " +
            "или введите 0 для возврата в предыдущее меню.";
    public static final String MENU_TICKET_BUY = "Пожалуйста, введите ID билета, " +
            "который Вы желаете приобрести, " +
            "или введите 0 для возврата в предыдущее меню.";
    public static final String MENU_TICKET_RETURN = "Пожалуйста, введите ID билета, " +
            "который Вы желаете сдать, " +
            "или введите 0 для возврата в предыдущее меню.";
    ...
    public static final String INVALID_MOVIE_TITLE = """
            Введено недопустимое название фильма. Название должно состоять минимум из 1 символа,
            но не превышать длину 100 символов.
    ...
    public static final String CREATING_MOVIE_START_TIME = """
            Пожалуйста, задайте дату и время начала сеанса в формате yyyy MM dd hh mm.
            Текущее время не может быть позже времени начала сеанса.""";
    ...
    public static final String MISSING_USER_TICKETS = "К сожалению, у Вас отсутствуют приобретенные билеты.";
