...
public final class Constants {
    ...
    public static final String MENU_ADMIN = """
            12 - для создания нового пользователя
            13 - для изменения данных пользователя
            14 - для создания фильма
            15 - для создания сеанса
            16 - для просмотра всех сеансов
            17 - для удаления сеанса
            18 - для удаления фильма
            """;
    ...
    public static final String MENU_SESSION_UPDATE = """
            ...
            """;
    public static final String MENU_SESSION_REMOVE = """
            Вы точно уверены, что хотите удалить сеанс?
            В случае продолжения все билеты на данный сеанс будут изъяты из оборота,
            а если сеанс еще не начался - денежные средства за билеты будут возвращены покупателям.
            Пожалуйста, введите:
            0 - для отмены операции удаления сеанса
            1 - для удаления сеанса и изъятия билетов на него из оборота
            """;
    public static final String MENU_MOVIE_UPDATE = """
            ...
            """;
    public static final String MENU_MOVIE_REMOVE = """
            Вы точно уверены, что хотите удалить фильм?
            В случае продолжения все сеансы с данным фильмом будут удалены,
            все билеты на данные сеансы будут изъяты из оборота,
            а если сеансы еще не начались - денежные средства за билеты будут возвращены покупателям.
            Пожалуйста, введите:
            0 - для отмены операции удаления фильма
            1 - для удаления фильма, всех сеансов с данным фильмом
            и изъятия всех билетов на эти сеансы из оборота
            """;
    public static final String MENU_USER_UPDATE = """
            Пожалуйста, введите:
            0 - для возврата к меню пользователя
            1 - для изменения уровня доступа пользователя
            2 - для изменения статуса пользователя
            """;
    public static final String MENU_USER_UPDATE_ROLE = """
            Пожалуйста, введите:
            0 - для возврата к меню пользователя
            1 - для установления уровня доступа пользователь
            2 - для установления уровня доступа менеджер
            3 - для установления уровня доступа администратор
            """;
    public static final String MENU_USER_UPDATE_STATUS = """
            Пожалуйста, введите:
            0 - для возврата к меню пользователя
            1 - для установления статуса активен
            2 - для установления статуса заблокирован
            3 - для установления статуса удален
            """;
    ...
    public static final String UPDATE_USER = """
            Пожалуйста, введите ID пользователя,
            данные которого Вы желаете изменить,
            или введите 0 для возврата в предыдущее меню.
            """;
    public static final String REMOVE_SESSION = """
            Пожалуйста, введите ID сеанса, который Вы желаете удалить
            или введите 0 для возврата к меню пользователя.
            """;
    public static final String REMOVE_MOVIE = """
            Пожалуйста, введите ID фильма, который Вы желаете удалить
            или введите 0 для возврата к меню пользователя.
            """;
    public static final String INCORRECT_USER = """
